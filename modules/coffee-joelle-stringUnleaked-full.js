...
(function() {
  var checkIfNewArticle, checkIfNewComments, cheerio, commentOptionTimeMS, get20MinCommentsV3, getDataTalkbackID, getLastCommentsAndDelete, keen, lastRequest, oUrls, partialcommenturl, request, requestArticleUrlForComments, rooturl, talkbackpath, unleakString, urlArr,
      ...
      if (error) {
        ...
        return tree(treepath).each(function(i, elem) {
          ...
          if (ref = listItem.attr('id'), indexOf.call(com.commentIDs, ref) < 0) {
            ...
            currDate = Date.UTC(unleakString(dt.substring(6, 10)), unleakString(dt.substring(3, 5)) - 1, unleakString(dt.substring(0, 2)), parseInt(unleakString(dt.substring(11, 13))) + timezoneOffsetInHours, unleakString(dt.substring(14)));
            ...
            return com.commentIDs.push(unleakString(listItem.attr('id')));
          }
        });
      }
    });
